...
struct PayToUserTransactionBroadcastToBlockchainFailed: KBIEvent {
    let client: Client
    let common: Common
...
extension PayToUserTransactionBroadcastToBlockchainFailed {
    init(errorCode: String, errorMessage: String, errorReason: String, offerID: String, orderID: String) throws {
        ...
        eventName = "pay_to_user_transaction_broadcast_to_blockchain_failed"
        eventType = "log"
