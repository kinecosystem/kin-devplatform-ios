...
struct MigrationRequestAccountMigrationSucceeded: KBIEvent {
    let client: Client
    let common: Common
    let eventName: String
    let eventType: String
    let migrationReason: KBITypes.MigrationReason
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case migrationReason = "migration_reason"
...
extension MigrationRequestAccountMigrationSucceeded {
    init(migrationReason: KBITypes.MigrationReason, publicAddress: String) throws {
        ...
        eventName = "migration_request_account_migration_succeeded"
        eventType = "log"

        self.migrationReason = migrationReason
