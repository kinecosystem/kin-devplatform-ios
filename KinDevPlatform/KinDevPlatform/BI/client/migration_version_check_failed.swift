...
/// When failing to get the blockchain version
struct MigrationVersionCheckFailed: KBIEvent {
    let client: Client
    let common: Common
...
extension MigrationVersionCheckFailed {
    init(errorCode: String, errorMessage: String, errorReason: String) throws {
        ...
        eventName = "migration_version_check_failed"
        eventType = "log"
