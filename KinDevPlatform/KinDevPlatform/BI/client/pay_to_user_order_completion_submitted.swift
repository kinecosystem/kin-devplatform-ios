...
struct PayToUserOrderCompletionSubmitted: KBIEvent {
    let client: Client
    let common: Common
...
extension PayToUserOrderCompletionSubmitted {
    init(offerID: String, orderID: String, origin: KBITypes.Origin) throws {
        ...
        eventName = "pay_to_user_order_completion_submitted"
        eventType = "log"
