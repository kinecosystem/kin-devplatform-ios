...
struct PayToUserTransactionBroadcastToBlockchainSucceeded: KBIEvent {
    let client: Client
    let common: Common
...
extension PayToUserTransactionBroadcastToBlockchainSucceeded {
    init(offerID: String, orderID: String, transactionID: String) throws {
        ...
        eventName = "pay_to_user_transaction_broadcast_to_blockchain_succeeded"
        eventType = "log"
