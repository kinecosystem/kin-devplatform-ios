...
struct PayToUserOrderCompleted: KBIEvent {
    let client: Client
    let common: Common
...
extension PayToUserOrderCompleted {
    init(kinAmount: Double, offerID: String, orderID: String, origin: KBITypes.Origin) throws {
        ...
        eventName = "pay_to_user_order_completed"
        eventType = "business"
