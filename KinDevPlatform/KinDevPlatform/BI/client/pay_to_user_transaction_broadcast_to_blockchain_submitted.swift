...
struct PayToUserTransactionBroadcastToBlockchainSubmitted: KBIEvent {
    let client: Client
    let common: Common
...
extension PayToUserTransactionBroadcastToBlockchainSubmitted {
    init(offerID: String, orderID: String) throws {
        ...
        eventName = "pay_to_user_transaction_broadcast_to_blockchain_submitted"
        eventType = "log"
