...
struct MigrationRequestAccountMigrationStarted: KBIEvent {
    let client: Client
    let common: Common
...
extension MigrationRequestAccountMigrationStarted {
    init(publicAddress: String) throws {
        ...
        eventName = "migration_request_account_migration_started"
        eventType = "log"
